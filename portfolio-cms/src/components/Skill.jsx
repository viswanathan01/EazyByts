...
const Skill = () => {
  ...
  return (
    <section className="py-24 bg-gray-500 text-white flex flex-col justify-center items-center">
      <div className="max-w-5xl mx-auto px-8 w-full">
        ...
        {loading ? (
          ...
          >
            <motion.div
              className="w-16 h-16 border-4 border-t-cyan-400 border-white rounded-full animate-spin mb-4"
